...
For a full read world example, check out this test case: [test-incoming-form.js](https://github.com/felixge/node-formidable/blob/master/test/simple/test-incoming-form.js) (in [node-formdiable](https://github.com/felixge/node-formidable)).
